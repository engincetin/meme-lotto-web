...
export const program_id = new PublicKey("DX7xRWJGYVWkUY4we7R9AeBRTToPb86AaqAFPvNYukTM");
export const main_counter_no_1 = new PublicKey("FUge3Tt8AAmMMUyucC3ZsWofmzkhfUHxxJuMZ6KdwK9i");
export const main_counter_no_2 = new PublicKey("Ba7xfXefd8Mup6fEaFBAcBujSs4fBqvpgyFfbNDbapxB");
export const manager_account = new PublicKey('CCSLJbiy2Fq2Phgj6jRGz2hsAgsyvXRSDpwjYwJG4eUH');
export const terms_account = new PublicKey('7kpB74L2NpySBgo9KpADb5QX8LJxdGGgx13jEmA71CWB');
